...
Check out the [Python SDK section](https://pollen-robotics.github.io/reachy-2023-docs/sdk/first-moves/arm/#from-the-joints) on how to switch between the two modes.
